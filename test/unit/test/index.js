'use strict';
let cJs = require('/Users/yuer/workspaceforme/category/career/container/opensource/c-data/test/unit/dest/index.js'); // require source code
...
cases.push(
    it('/Users/yuer/workspaceforme/category/career/container/opensource/c-data/test/unit/dest/index.js', {"test":"","tar":"function"},
         'object',
         "[\n     [['a', 1], {a: 1}],\n     [['a', 1, 'b'], {a: 1, b: null}]\n]",
         [
     [['a', 1], {a: 1}],
